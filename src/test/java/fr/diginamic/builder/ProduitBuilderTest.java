...
public class ProduitBuilderTest {
    ...
    public void createProduitWithProduitBuilder() {
        ...
        Additif additif1 = new Additif("Additif1",3, UNITE.MILLI_GRAMMES);
        Additif additif2 = new Additif("Additif2",3, UNITE.MILLI_GRAMMES);

        Produit produit = new ProduitBuilder()
                .appendNom("ProductName")
                .appendGrade("Grade")
                .appendIngredient(ingredient)
                .appendAdditif(additif1)
                .appendAdditif(additif2)
        ...
        assert(produit.getAdditifs().size() == 2);
        assert(produit.getAdditifs().get(0).getNom().equals("Additif1"));
        assert(produit.getAdditifs().get(1).getNom().equals("Additif2"));
